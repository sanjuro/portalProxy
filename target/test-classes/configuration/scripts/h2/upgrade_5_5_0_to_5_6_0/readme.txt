The H2 database migration from 5.5.0 to 5.6.0 involves running the following steps in the order mentioned:
...
5. Run model-upgrade-5.5.0-to-5.6.0.sql
6. Run contentref-upgrade-5.5.0-to-5.6.0.sql
